...
public class ScriptTemplatesGenerate
{
    ...
    [UnityEditor.MenuItem("Assets/Create/My C# Script", false, 80)]
    public static void CreateCShapeScript()
    {
        ScriptGenerate(false);
    }

    [UnityEditor.MenuItem("Assets/Create/My C# Behaviour Script", false, 80)]
    public static void CreateBehaviourCShapeScript()
    {
        ScriptGenerate(true);
    }
    ...
    private static void ScriptGenerate(bool isMono)
    {
        ...
        {
            if (isMono)
                UnityEditor.ProjectWindowUtil.CreateAssetWithContent("NewBehaviourScript.cs", 
                    File.ReadAllText(tempCshapeMonoBehaviourPath), 
                    UnityEditor.EditorGUIUtility.IconContent("cs Script Icon").image as Texture2D);
            else
                UnityEditor.ProjectWindowUtil.CreateAssetWithContent("NewScript.cs", 
    ...
    {
        // E:\StudyGit\UnityUGUIStudy\Assets\Code\UIFramework\NewBehaviourScript.cs
        /// <summary>
        ...
        //     UnityEditor.AssetDatabase.ImportAsset(newFilePath);
        // }
